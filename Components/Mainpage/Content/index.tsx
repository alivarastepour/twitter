...
const Content = () => (
    <div className="mp-fl-2">
        ...
        <div className="ct-ch-4">
            <div className={`ct-ch-fl-1 ${styles.mainPageButton + " " + styles.whiteButton}`}>
                <div className={styles.logo}>
                    <GoogleLogo/>
                </div>
                <div className={` ${styles.text} text font font-eb`}>Sign up with Google</div>
            </div>
            <div className={`${styles.mainPageButton + " " + styles.whiteButton} ct-ch-fl-2`}>
                <div className={styles.logo}>
                    <AppleLogo/>
                </div>
                <div className={` ${styles.text} text font font-eb`}>Sign up with Apple</div>
            </div>
            ...
            <div className={`ct-ch-fl ${styles.mainPageButton + " " + styles.blueButton}`}>
        ...
        <div className='ct-ch-5'>
            ...
            <div className="ct-ch-fl">
                <div className={`font font-b ${styles.mainPageButton+ " " + styles.whiteBlueButton}`}>
                    Sign in
                </div>
            </div>
        </div>
