...
import { signOut } from "../Handlers/sideBarHandlers";
      ...
      <Wrapper>
        <List>
          ...
          <ListItem>
            <button
              className={
                button.blueButton + " " + styles.tweet + " font font-b"
              }
        ...
        <div className="profile-container" onClick={() => signOut(router)}>
          ...
          <div className="font font-m">
            <span className="pc-username">@alivarastepour</span>
          </div>
          <div>
            <MoreHorizIcon />
          </div>
